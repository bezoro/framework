...
/// <summary>
///     Defines a job-style iterator over four component columns with entity access.
/// </summary>
...
public interface IForEachEntity<T1, T2, T3, T4>
	where T1 : struct
	where T2 : struct
	where T3 : struct
	where T4 : struct
{
	...
	void Execute(Entity entity, ref T1 component1, in T2 component2, in T3 component3, in T4 component4);
}
