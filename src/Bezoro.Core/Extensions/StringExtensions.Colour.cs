...
using ColorType = Bezoro.Core.Types.Color;
...
public static partial class StringExtensions
{
	...
	/// <returns>The string wrapped in a &lt;color&gt; tag.</returns>
	public static string Color(this string text, ColorType color) =>
	...
	/// <returns>The string wrapped in a &lt;color&gt; tag.</returns>
	[Obsolete("Use Color(string) or Color(Color) instead.")]
	public static string ColorHex(this string text, string hexOrCss) =>
		ColorType.TryParse(hexOrCss.AsSpan(), CultureInfo.InvariantCulture, out var c)
			? text.Color(c)
	...
	public static string Color(this string text, byte r, byte g, byte b, byte a = 255) =>
		text.Color(ColorType.FromArgb(a, r, g, b));
	...
	public static string Color(this string text, float r, float g, float b, float a = 1f) =>
		text.Color(new ColorType(r, g, b, a));
	...
	public static string Color(this string text, uint rgba32) =>
		text.Color(ColorType.FromRgba32(rgba32));
