...
public static class EnumerableExtensions
{
    ...
    /// Uses <see cref="ICollection{T}"/>, <see cref="IReadOnlyCollection{T}"/>, and <see cref="ICollection"/> for O(1) retrieval.
    ...
    /// <returns>A string composed of the string representations of the sequence elements, separated by <paramref name="separator"/>.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
