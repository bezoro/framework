...
public static class ValidationHelper
{
    ...
    /// </summary>
    /// <typeparam name="TException">The type of exception to throw. Must have a public constructor accepting a <see cref="string"/> message.</typeparam>
    ...
    /// <summary>
    /// Validates that both <paramref name="file"/> and <paramref name="rank"/> are within [<paramref name="min"/>, <paramref name="max"/>] (inclusive).
    /// </summary>
