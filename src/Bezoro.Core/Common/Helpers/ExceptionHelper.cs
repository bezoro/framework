...
public static class ExceptionHelper
{
	...
	/// </exception>
	/// <remarks>
	/// The generated exception message will include the exception type, (optionally) the object type, method name, and error message.
	/// </remarks>
	...
	/// <summary>
	/// Formats a detailed exception message including exception type, object context, method, parameter names and an additional message.
	/// </summary>
