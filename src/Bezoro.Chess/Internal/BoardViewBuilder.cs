...
/// <summary>
///     Builds a 2D array board representation from a FEN string for Unity rendering.
/// </summary>
internal static class BoardViewBuilder
{
    /// <summary>
    ///     Builds an 8x8 board array from a FEN position.
    ///     Array is indexed [file, rank] where file 0 = 'a' and rank 0 = '1'.
    ///     Uppercase = white pieces, lowercase = black pieces, null = empty square.
    /// </summary>
    public static char?[,] Build(Fen fen)
	{
    ...
    /// </summary>
    public static char? GetPieceAt(char?[,] board, string square)
	{
		if (square.Length < 2)
			return null;
