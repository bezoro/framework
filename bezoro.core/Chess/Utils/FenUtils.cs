...
namespace Bezoro.Core.Chess.Utils
{
	...
	{
		private const string StandardBoardFen = "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1";

		public static FenData StandardBoard => ParseFen(StandardBoardFen);
