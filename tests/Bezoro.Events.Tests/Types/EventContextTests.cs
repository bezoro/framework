...
{
	[Fact]
	public void Constructor_WhenCalled_ShouldStoreData()
	{
	...
	[Fact]
	public void Data_WhenAccessed_ShouldPreserveAllFields()
	{
	...
	[Fact]
	public void Handled_WhenCreated_ShouldDefaultToFalse()
	{
		var ctx = new EventContext<TestEventA>(new(1));
