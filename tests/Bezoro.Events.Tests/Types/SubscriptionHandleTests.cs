...
{
	[Fact]
	public void Constructor_WhenIdIsNegative_ShouldNotBeValid()
	{
	...
	[Fact]
	public void Constructor_WhenIdIsPositive_ShouldBeValid()
	{
		var handle = new SubscriptionHandle(1);
	...
	[Fact]
	public void Default_WhenCompared_ShouldEqualNone()
	{
	...
	[Fact]
	public void None_WhenAccessed_ShouldHaveIdZero()
	{
		SubscriptionHandle.None.Id.Should().Be(0);
	}

	[Fact]
	public void None_WhenAccessed_ShouldNotBeValid()
	{
		SubscriptionHandle.None.IsValid.Should().BeFalse();
	}

	[Fact]
	public void ToString_WhenCalled_ShouldContainId()
	{
