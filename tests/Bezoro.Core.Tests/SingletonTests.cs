...
public static class SingletonTests
{
	...
	private abstract class AbstractSingleton : Singleton<AbstractSingleton> { }

	private sealed class DefaultSingleton : Singleton<DefaultSingleton>, IDisposable
	{
	...
	private sealed class PublicCtorSingleton : Singleton<PublicCtorSingleton>, IDisposable
	{
		public static int DisposeCount;
	...
	private sealed class ThrowOnDisposeSingleton : Singleton<ThrowOnDisposeSingleton>, IDisposable
	{
		public void Dispose()
		{
