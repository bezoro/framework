...
{
	[Fact]
	public void Match_WhenInspected_ShouldBePublicFactory()
	{
		var method = typeof(TypingResult).GetMethod(nameof(TypingResult.Match), BindingFlags.Public | BindingFlags.Static);
